    ...
    <div class="flex min-h-full flex-col">
        <header class="shrink-0 border-b border-gray-200 bg-white">
            <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                <svg viewBox="0 -10 100 100" width="150" height="150">
                    <image href="{{ asset('images/logo-no-text.svg') }}" width="100" height="100" x="0" y="0" />
                </svg>
        ...
        <div class="mx-auto flex w-full max-w-7xl items-start gap-x-8 px-4 py-10 sm:px-6 lg:px-8">
            <aside class="sticky top-8 hidden w-44 shrink-0 lg:block">
                ...
                <div class="flex grow flex-col gap-y-1 overflow-y-auto bg-white px-6 pb-2">
            ...
            <main class="flex-1 border border-gray-500 p-2" style="height: calc(100vh - 200px)">
                <!-- Main area -->
                main
            </main>

            <aside class="sticky top-8 hidden w-96 shrink-0 xl:block p-2">
                <!-- Right column area -->
                right
            </aside>
        </div>
